package net.pingfang.serviceImpl.huangPu.bay;
...
@Service
public class MjBayServiceImpl implements MjBayService {
	...
	public Map<String,Object> getBatchMjBayList(List<VesselBayVo> vesselBayList) {
		...
		//通过岸桥编号获取岸桥配制
		List<CranePreparationVo> cnList = cranePreparationService.getListCranePreparation(craneNumList, "2");
		//BAY位数据		
